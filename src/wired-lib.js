...
export class Wires {
  ...
  _line(x1, y1, x2, y2, existingPath) {
    ...
    path.bcurveTo(
      midDispX + x1 + (x2 - x1) * divergePoint + this._getOffset(-offset, offset),
    ...
    path.bcurveTo(
      midDispX + x1 + (x2 - x1) * divergePoint + this._getOffset(-halfOffset, halfOffset),
...
export const _WIRES_ = new Wires();
// if (!window._WIRES_) {
